...
class ZCrystals extends React.Component<{ items: { [key: string]: TPP.Item[] } }, {}> {
    //Normalium Z, Fightinium Z, Waterium Z, Firium Z, Grassium Z, Rockium Z, Electrium Z, Ghostinium Z, Darkinium Z, Dragonium Z, Fairium Z, Groundium Z, 
    private static significantCrystals = [776, 807, 782, 813, 778, 809, 777, 808, 780, 811, 788, 819, 779, 810, 786, 820, 791, 822, 790, 821, 739, 824, 784, 815 ];
    render() {
